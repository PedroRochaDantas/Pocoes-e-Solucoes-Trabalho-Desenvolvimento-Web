  ...
  await Pocao.bulkCreate([
    {
      ...
      imagem:
        "https://i.ibb.co/ZzS7xb2/rsz-sky.png",
      preco: 300
    },

    {
      ...
      imagem:
        "https://i.ibb.co/pyhZJXf/rsz-lilas.png",
      preco: 200
    },

    {
      ...
      imagem:
        "https://i.ibb.co/DkzdL1q/rsz-pinus.png",
      preco: 3000
    },

    {
      ...
      imagem:
        "https://i.ibb.co/9p872NK/rsz-1beleza.png",
      preco: 100
    },

    {
      ...
      imagem:
        "https://i.ibb.co/PrC09MP/rsz-2unicornio.png",
      preco: 120
    },

    {
      ...
      imagem:
        "https://i.ibb.co/s9Lyvj8/rsz-verdades.png",
      preco: 150
    }
  ]);
